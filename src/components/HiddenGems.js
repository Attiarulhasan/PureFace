...
import gem4 from '../images/gem4.png';
import gem5 from '../images/gem5.png';
import gem6 from '../images/gem6.png';
...
`
        ...
        <SwiperSlide>
            ...
            <img src={gem1} className="best-img" />
        ...
        <SwiperSlide>
        <div className='img-container'>
        <img src={gem2} className="best-img"/>
            <div className='overlay'>
                <div className='text'>Add To Cart</div>
            </div>
            <span className='heart-overly'><img src={overlay}/></span>
        ...
        <SwiperSlide>
        <div className='img-container'>
         <img src={gem3} className="best-img"/>
            <div className='overlay'>
                <div className='text'>Add To Cart</div>
            </div>
            <span className='heart-overly'><img src={overlay}/></span>
        ...
        <SwiperSlide>
        <div className='img-container'>
        <img src={gem4} className="best-img"/>
            <div className='overlay'>
                <div className='text'>Add To Cart</div>
            </div>
            <span className='heart-overly'><img src={overlay}/></span>
        ...
        <SwiperSlide>
        <div className='img-container'>
           <img src={gem5} className="best-img"/>
            <div className='overlay'>
                <div className='text'>Add To Cart</div>
            </div>
            <span className='heart-overly'><img src={overlay}/></span>
        ...
        <SwiperSlide>
        <div className='img-container'>
        <img src={gem6} className="best-img"/>
            <div className='overlay'>
                <div className='text'>Add To Cart</div>
            </div>
            <span className='heart-overly'><img src={overlay}/></span>
